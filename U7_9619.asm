...
* ### EPROM PROGRAMMER
* /
* This area appears to be for a EPROM programmer
...
ZEE5A   LEAY    AC1CR_VEC,PCR            *EE5A: 31 8D F9 BE    '1...'
        LDA     #$08                     *EE5E: 86 08          '..'
ZEE60   CLR     [,--Y]                   *EE60: 6F B3          'o.'
        DECA                             *EE62: 4A             'J'
        BNE     ZEE60                    *EE63: 26 FB          '&.'
        LDA     #$0F                     *EE65: 86 0F          '..'
        STA     [>PIA1PRB_VEC,PCR]       *EE67: A7 9D F9 AD    '....'
        LDA     #$34                     *EE6B: 86 34          '.4'
        STA     [>PIA1CRB_VEC,PCR]       *EE6D: A7 9D F9 A9    '....'
        LDA     [>PIA1PRB_VEC,PCR]       *EE71: A6 9D F9 A3    '....'
        CLR     [>PIA1CRB_VEC,PCR]       *EE75: 6F 9D F9 A1    'o...'
        ANDA    #$C0                     *EE79: 84 C0          '..'
...
ZEE94   LDA     #$3F                     *EE94: 86 3F          '.?'
        STA     [>PIA1PRB_VEC,PCR]       *EE96: A7 9D F9 7E    '...~'
        LDD     #M1805                   *EE9A: CC 18 05       '...'
        BRA     ZEEA2                    *EE9D: 20 03          ' .'
ZEE9F   LDD     #M1401                   *EE9F: CC 14 01       '...'
ZEEA2   STA     M009D                    *EEA2: 97 9D          '..'
        LDA     #$FF                     *EEA4: 86 FF          '..'
        STA     [>PIA1PRA_VEC,PCR]       *EEA6: A7 9D F9 6A    '...j'
        STA     [>PIA2PRA_VEC,PCR]       *EEAA: A7 9D F9 5E    '...^'
        LDA     #$34                     *EEAE: 86 34          '.4'
        STA     [>PIA2CRA_VEC,PCR]       *EEB0: A7 9D F9 5A    '...Z'
        STA     [>PIA1CRA_VEC,PCR]       *EEB4: A7 9D F9 5E    '...^'
        STA     [>PIA1CRB_VEC,PCR]       *EEB8: A7 9D F9 5E    '...^'
...
ZEFD0   LEAX    -$01,X                   *EFD0: 30 1F          '0.'
        ...
        FCC     "P"                      *EFDB: 50             'P'
        FCB     $00,$E8                  *EFDC: 00 E8          '..'
        FCC     "cS"                     *EFDE: 63 53          'cS'
        FCB     $00,$E7,$00              *EFE0: 00 E7 00       '...'
        FCC     "T"                      *EFE3: 54             'T'
        FCB     $00,$E7                  *EFE4: 00 E7          '..'
        FCC     "]"                      *EFE6: 5D             ']'
...
* ### ASSEMBLER
        FCB     $AA                      *F000: AA             '.'
        FCC     "U"                      *F001: 55             'U'
        FCB     $F0,$06,$00,$00          *F002: F0 06 00 00    '....'
        FCC     "DI"                     *F006: 44 49          'DI'
        FCB     $00,$F0,$1C              *F008: 00 F0 1C       '...'
        FCC     "DB"                     *F00B: 44 42          'DB'
        FCB     $00,$F0                  *F00D: 00 F0          '..'
        FCC     "9XD"                    *F00F: 39 58 44       '9XD'
...
COMAND  LDY     #PROMPT                  *F86E: 10 8E FD 2E    '....'  GET PROMPT STRING
        ...
        LEAY    REGTBL,PCR               *F882: 31 8D 04 C4    '1...'
...
* register name/offset lookup table
REGTBL  FCC     "A"                      *FD4A: 41             'A'
...
ZFDB8   LBRA    GOCMD                    *FDB8: 16 FD AE       '...'
...
ZFF73   PSHS    D                        *FF73: 34 06          '4.'
        ...
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FFA6: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FFAC: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FFB2: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FFB8: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FFBE: FF FF FF FF FF FF '......'
