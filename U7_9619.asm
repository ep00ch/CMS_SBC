...
_SETCL1 JSR     _XCMDCHK                 *E70A: BD FE E0       '...'   CHECK VALID INPUT
...
_RDCL2  LDB     #12                      *E79A: C6 0C          '..'    SET LOOP COUNT
        LDX     ,S                       *E79C: AE E4          '..'
_RDCL3  BSR     _RTC_READ                *E79E: 8D 0F          '..'
...
ME802   STU     [D,U]                    *E802: EF DB          '..'
        LBRA    ZE863                    *E804: 16 00 5C       '..\'
ZE807   LBRA    ZE87A                    *E807: 16 00 70       '..p'
ME80A   JSR     Z0000                    *E80A: 9D 00          '..'
        STU     MCCFF                    *E80C: FF CC FF       '...'
        FCB     $CD                      *E80F: CD             '.'
        STU     MCEFF                    *E810: FF CE FF       '...'
        FCB     $CF                      *E813: CF             '.'
        STU     MC8FF                    *E814: FF C8 FF       '...'
        ADCB    #$FF                     *E817: C9 FF          '..'
        ORB     #$FF                     *E819: CA FF          '..'
        ADDB    #$FF                     *E81B: CB FF          '..'
        ANDB    M00FF                    *E81D: D4 FF          '..'
        BITB    M0008                    *E81F: D5 08          '..'
...
ZE827   PSHS    A                        *E827: 34 02          '4.'
        ...
        PULS    A                        *E833: 35 02          '5.'
        LDA     [MFFE3,PC]               *E835: A6 9D FF E3    '....'
        ANDA    #$7F                     *E839: 84 7F          '..'
        ANDCC   #$FE                     *E83B: 1C FE          '..'
        RTS                              *E83D: 39             '9'
ZE83E   ORCC    #$01                     *E83E: 1A 01          '..'
        PULS    PC,A                     *E840: 35 82          '5.'
ZE842   PSHS    A                        *E842: 34 02          '4.'
...
ZE852   LDA     [PIADDR1,PC]             *E852: A6 9D FF C8    '....'
        BITA    >ME821,PCR               *E856: A5 8D FF C7    '....'
        BEQ     ZE852                    *E85A: 27 F6          ''.'
        PULS    A                        *E85C: 35 02          '5.'
        STA     [MFFBA,PC]               *E85E: A7 9D FF BA    '....'
        RTS                              *E862: 39             '9'
...
ZEB1C   PSHS    X,D                      *EB1C: 34 16          '4.'
        LEAX    M_ESSGES,PCR             *EB1E: 30 8D 01 D3    '0...'
...
ZEB8F   ANDA    #$0F                     *EB8F: 84 0F          '..'
        ADDA    #$30                     *EB91: 8B 30          '.0'
        CMPA    #$39                     *EB93: 81 39          '.9'
        BLS     ZEB99                    *EB95: 23 02          '#.'
        ADDA    #$07                     *EB97: 8B 07          '..'
...
ZEBB2   LDA     ,X+                      *EBB2: A6 80          '..'
        CMPA    #$20                     *EBB4: 81 20          '. '
        BEQ     ZEBB2                    *EBB6: 27 FA          ''.'
...
M_ESSGES FCB     $00,$12,$00              *ECF5: 00 12 00       '...'
        FCC     "2"                      *ECF8: 32             '2'
        FCB     $00                      *ECF9: 00             '.'
        FCC     "M"                      *ECFA: 4D             'M'
        FCB     $00                      *ECFB: 00             '.'
...
ZEE60   CLR     [,--Y]                   *EE60: 6F B3          'o.'
        ...
        LDA     #$0F                     *EE65: 86 0F          '..'
        STA     [MF9AD,PC]               *EE67: A7 9D F9 AD    '....'
        LDA     #$34                     *EE6B: 86 34          '.4'
        STA     [MF9A9,PC]               *EE6D: A7 9D F9 A9    '....'
        LDA     [MF9A3,PC]               *EE71: A6 9D F9 A3    '....'
        CLR     [MF9A1,PC]               *EE75: 6F 9D F9 A1    'o...'
        ANDA    #$C0                     *EE79: 84 C0          '..'
...
ZEE94   LDA     #$3F                     *EE94: 86 3F          '.?'
        STA     [MF97E,PC]               *EE96: A7 9D F9 7E    '...~'
        LDD     #M1805                   *EE9A: CC 18 05       '...'
        BRA     ZEEA2                    *EE9D: 20 03          ' .'
ZEE9F   LDD     #M1401                   *EE9F: CC 14 01       '...'
ZEEA2   STA     M009D                    *EEA2: 97 9D          '..'
        LDA     #$FF                     *EEA4: 86 FF          '..'
        STA     [MF96A,PC]               *EEA6: A7 9D F9 6A    '...j'
        STA     [MF95E,PC]               *EEAA: A7 9D F9 5E    '...^'
        LDA     #$34                     *EEAE: 86 34          '.4'
        STA     [MF95A,PC]               *EEB0: A7 9D F9 5A    '...Z'
        STA     [MF95E,PC]               *EEB4: A7 9D F9 5E    '...^'
        STA     [MF95E,PC]               *EEB8: A7 9D F9 5E    '...^'
...
ZEECC   CMPY    M0099                    *EECC: 10 9C 99       '...'
        ...
        TFR     Y,D                      *EED1: 1F 20          '. '
        STA     [MF941,PC]               *EED3: A7 9D F9 41    '...A'
        STB     [MF939,PC]               *EED7: E7 9D F9 39    '...9'
        LDA     [MF931,PC]               *EEDB: A6 9D F9 31    '...1'
        CLRB                             *EEDF: 5F             '_'
        RTS                              *EEE0: 39             '9'
...
ZEEF6   CMPY    M0099                    *EEF6: 10 9C 99       '...'
        ...
        TFR     Y,D                      *EEFB: 1F 20          '. '
        STA     [MF917,PC]               *EEFD: A7 9D F9 17    '....'
        STB     [MF90F,PC]               *EF01: E7 9D F9 0F    '....'
        PULS    A                        *EF05: 35 02          '5.'
        CMPA    #$FF                     *EF07: 81 FF          '..'
        BEQ     ZEF19                    *EF09: 27 0E          ''.'
        TST     [MF901,PC]               *EF0B: 6D 9D F9 01    'm...'
        STA     [MF8FD,PC]               *EF0F: A7 9D F8 FD    '....'
ZEF13   TST     [ZF8FB,PC]               *EF13: 6D 9D F8 FB    'm...'
...
ZEF1B   PSHS    X,D                      *EF1B: 34 16          '4.'
        ...
        LDA     $01,X                    *EF23: A6 01          '..'
        STA     [MF8E3,PC]               *EF25: A7 9D F8 E3    '....'
        LDA     #$3A                     *EF29: 86 3A          '.:'
        STA     [MF8E3,PC]               *EF2B: A7 9D F8 E3    '....'
        LDB     #$FF                     *EF2F: C6 FF          '..'
        STB     [MF8DB,PC]               *EF31: E7 9D F8 DB    '....'
        ORA     #$04                     *EF35: 8A 04          '..'
        STA     [MF8D7,PC]               *EF37: A7 9D F8 D7    '....'
        LDA     #$64                     *EF3B: 86 64          '.d'
        LBSR    ZEFCB                    *EF3D: 17 00 8B       '...'
        LDA     ,X                       *EF40: A6 84          '..'
        STA     [MF8C6,PC]               *EF42: A7 9D F8 C6    '....'
        CLRB                             *EF46: 5F             '_'
...
ZEF5B   ANDA    #$FB                     *EF5B: 84 FB          '..'
        STA     [MF8B1,PC]               *EF5D: A7 9D F8 B1    '....'
        CLR     [MF8AB,PC]               *EF61: 6F 9D F8 AB    'o...'
        ORA     #$04                     *EF65: 8A 04          '..'
        STA     [MF8A7,PC]               *EF67: A7 9D F8 A7    '....'
        LDA     $02,X                    *EF6B: A6 02          '..'
        STA     [MF89B,PC]               *EF6D: A7 9D F8 9B    '....'
        LDA     #$4B                     *EF71: 86 4B          '.K'
        BSR     ZEFCB                    *EF73: 8D 56          '.V'
        LDA     [MF897,PC]               *EF75: A6 9D F8 97    '....'
        PULS    PC,X,D                   *EF79: 35 96          '5.'
ZEF7B   PSHS    X,A                      *EF7B: 34 12          '4.'
        LDA     #$02                     *EF7D: 86 02          '..'
        STA     M0093                    *EF7F: 97 93          '..'
        LDA     #$2B                     *EF81: 86 2B          '.+'
        STA     [MF88B,PC]               *EF83: A7 9D F8 8B    '....'
        LDB     #$FF                     *EF87: C6 FF          '..'
        STB     [MF883,PC]               *EF89: E7 9D F8 83    '....'
        ORA     #$04                     *EF8D: 8A 04          '..'
        STA     [MF87F,PC]               *EF8F: A7 9D F8 7F    '....'
        LDX     M0097                    *EF93: 9E 97          '..'
        LDA     $03,X                    *EF95: A6 03          '..'
        STA     [MF871,PC]               *EF97: A7 9D F8 71    '...q'
        LDA     #$32                     *EF9B: 86 32          '.2'
        BSR     ZEFCB                    *EF9D: 8D 2C          '.,'
        PULS    PC,X,A                   *EF9F: 35 92          '5.'
ZEFA1   PSHS    X,D                      *EFA1: 34 16          '4.'
...
ZEFD0   LEAX    -$01,X                   *EFD0: 30 1F          '0.'
        ...
        ASLB                             *F010: 58             'X'
        LSRA                             *F011: 44             'D'
        NEG     M00F0                    *F012: 00 F0          '..'
        LSR     -$0C,U                   *F014: 64 54          'dT'
        LSRA                             *F016: 44             'D'
        NEG     M00F0                    *F017: 00 F0          '..'
        NEG     $00,X                    *F019: 60 00          '`.'
        NEG     M00BD                    *F01B: 00 BD          '..'
        LDU     M2A27                    *F01D: FE 2A 27       '.*''
        INC     M00BD                    *F020: 0C BD          '..'
        LDU     MBF24                    *F022: FE BF 24       '..$'
        FCB     $05                      *F025: 05             '.'
...
ZF0A4   CLR     M0022                    *F0A4: 0F 22          '."'
        ...
        RTI                              *F0AD: 3B             ';'
ZF0AE   CLR     M001E                    *F0AE: 0F 1E          '..'
        CLR     M001F                    *F0B0: 0F 1F          '..'
ZF0B2   STA     M002C                    *F0B2: 97 2C          '.,'
        CLRA                             *F0B4: 4F             'O'
        CLRB                             *F0B5: 5F             '_'
        STD     M0027                    *F0B6: DD 27          '.''
        STD     M0029                    *F0B8: DD 29          '.)'
        CLR     M002B                    *F0BA: 0F 2B          '.+'
        LDX     M001E                    *F0BC: 9E 1E          '..'
        STX     M0020                    *F0BE: 9F 20          '. '
        CLR     M001E                    *F0C0: 0F 1E          '..'
        CLR     M001F                    *F0C2: 0F 1F          '..'
        LDX     IOBUF                    *F0C4: 9E 04          '..'
        LDD     #M2048                   *F0C6: CC 20 48       '. H'
ZF0C9   STA     ,X+                      *F0C9: A7 80          '..'
        DECB                             *F0CB: 5A             'Z'
        BNE     ZF0C9                    *F0CC: 26 FB          '&.'
        LEAX    -$46,X                   *F0CE: 30 88 BA       '0..'
        LDU     ,Y                       *F0D1: EE A4          '..'
        JSR     ZFF21                    *F0D3: BD FF 21       '..!'
        TFR     U,Y                      *F0D6: 1F 32          '.2'
        LDA     ,Y                       *F0D8: A6 A4          '..'
        CMPA    #$11                     *F0DA: 81 11          '..'
        BEQ     ZF118                    *F0DC: 27 3A          '':'
        CMPA    #$10                     *F0DE: 81 10          '..'
        BEQ     ZF133                    *F0E0: 27 51          ''Q'
        LEAX    $02,X                    *F0E2: 30 02          '0.'
        JSR     ZFF27                    *F0E4: BD FF 27       '..''
        LDA     -$01,Y                   *F0E7: A6 3F          '.?'
        PSHS    X                        *F0E9: 34 10          '4.'
        LDX     #MF4B5                   *F0EB: 8E F4 B5       '...'
        ANDA    #$F0                     *F0EE: 84 F0          '..'
        LSRA                             *F0F0: 44             'D'
        LSRA                             *F0F1: 44             'D'
        LDU     A,X                      *F0F2: EE 86          '..'
        ...
        LSRA                             *F105: 44             'D'
        LDB     A,U                      *F106: E6 C6          '..'
        BCS     ZF10E                    *F108: 25 04          '%.'
        LSRB                             *F10A: 54             'T'
        LSRB                             *F10B: 54             'T'
        LSRB                             *F10C: 54             'T'
        LSRB                             *F10D: 54             'T'
ZF10E   ANDB    #$0F                     *F10E: C4 0F          '..'
        ASLB                             *F110: 58             'X'
        LDU     #MF555                   *F111: CE F5 55       '..U'
        EXG     X,U                      *F114: 1E 13          '..'
        JMP     [B,X]                    *F116: 6E 95          'n.'
ZF118   JSR     ZFF21                    *F118: BD FF 21       '..!'
        LDA     -$01,Y                   *F11B: A6 3F          '.?'
        PSHS    X                        *F11D: 34 10          '4.'
...
MF4B5   FCB     $F6,$D5,$F4,$F5,$F5,$95  *F4B5: F6 D5 F4 F5 F5 95 '......'
        ...
        FCB     $D0,$D0                  *F553: D0 D0          '..'
MF555   FCB     $F2,$10,$F2,$15,$F2,$1C  *F555: F2 10 F2 15 F2 1C '......'
        FCB     $F2                      *F55B: F2             '.'
        FCC     "D"                      *F55C: 44             'D'
        FCB     $F2                      *F55D: F2             '.'
        FCC     "D"                      *F55E: 44             'D'
...
START   LDA     #$9F                     *F800: 86 9F          '..'    DIRECT PAGE ADDR
        ...
        STS     Z0000                    *F80A: 10 DF 00       '...'   SAVE INITIAL USER SP
...
A1INIT2 CLR     ,X+                      *F831: 6F 80          'o.'    CLEAR BKPT TABLE
        ...
        LDX     #BKPT                    *F837: 8E FC A0       '...'   GET ADDR OF BKPT SERVICE ROUTINE
        STX     SWIVCT                   *F83A: 9F 11          '..'
        LDX     #SSBK                    *F83C: 8E FC D1       '...'
        STX     NMIVCT                   *F83F: 9F 17          '..'
...
COMAND  LDY     #PROMPT                  *F86E: 10 8E FD 2E    '....'  GET PROMPT STRING
        ...
        BSR     ZF8B5                    *F886: 8D 2D          '.-'
        TSTA                             *F888: 4D             'M'     COMPARE TO TEXT
        BNE     ZF89E                    *F889: 26 13          '&.'
MF88B   LDY     ME800                    *F88B: 10 BE E8 00    '....'
        CMPY    #MAA55                   *F88F: 10 8C AA 55    '...U'
        BNE     ILLCMD                   *F893: 26 0D          '&.'    EXIT IF TABLE END
        LDY     ME802                    *F895: 10 BE E8 02    '....'
        BSR     ZF8B5                    *F899: 8D 1A          '..'
MF89B   TSTA                             *F89B: 4D             'M'
        BEQ     ILLCMD                   *F89C: 27 04          ''.'
...
ZF90B   PSHS    X                        *F90B: 34 10          '4.'
        LDX     Z0000                    *F90D: 9E 00          '..'
MF90F   ABX                              *F90F: 3A             ':'
        TFR     X,Y                      *F910: 1F 12          '..'
        PULS    X                        *F912: 35 10          '5.'
        LBSR    CHKEOL                   *F914: 17 05 13       '...'
MF917   BNE     ZF938                    *F917: 26 1F          '&.'
        LDA     #$3D                     *F919: 86 3D          '.='
...
ZF9C5   RTS                              *F9C5: 39             '9'
DSPREG  LDY     Z0000                    *F9C6: 10 9E 00       '...'
        LDX     #MF9F3                   *F9C9: 8E F9 F3       '...'
...
ZF9F2   RTS                              *F9F2: 39             '9'
MF9F3   BRA     ZFA48                    *F9F3: 20 53          ' S'
        NEGB                             *F9F5: 50             'P'
        MUL                              *F9F6: 3D             '='
        CMPA    #$00                     *F9F7: 81 00          '..'
        BRA     ZFA3E                    *F9F9: 20 43          ' C'
        COMA                             *F9FB: 43             'C'
        MUL                              *F9FC: 3D             '='
        SUBA    #$41                     *F9FD: 80 41          '.A'
        MUL                              *F9FF: 3D             '='
        SUBA    #$42                     *FA00: 80 42          '.B'
        MUL                              *FA02: 3D             '='
        SUBA    #$20                     *FA03: 80 20          '. '
        LSRA                             *FA05: 44             'D'
        NEGB                             *FA06: 50             'P'
        MUL                              *FA07: 3D             '='
        SUBA    #$58                     *FA08: 80 58          '.X'
        MUL                              *FA0A: 3D             '='
        CMPA    #$59                     *FA0B: 81 59          '.Y'
        MUL                              *FA0D: 3D             '='
        CMPA    #$55                     *FA0E: 81 55          '.U'
        MUL                              *FA10: 3D             '='
        CMPA    #$20                     *FA11: 81 20          '. '
        NEGB                             *FA13: 50             'P'
        COMA                             *FA14: 43             'C'
...
BKPT    LDA     #$9F                     *FCA0: 86 9F          '..'    DEBUG DP
        ...
        STS     Z0000                    *FCA6: 10 DF 00       '...'   SAVE USER STACK PTR
...
SSBK    LDA     #$01                     *FCD1: 86 01          '..'
        ...
        TFR     A,DP                     *FCD8: 1F 8B          '..'
        STS     Z0000                    *FCDA: 10 DF 00       '...'   SAVE USER STACK
...
WRTLIN  PSHS    D                        *FE38: 34 06          '4.'
        ...
        BEQ     ZFE47                    *FE41: 27 04          ''.'
        LDA     #$0A                     *FE43: 86 0A          '..'
        BSR     A1OUTCHR                 *FE45: 8D 32          '.2'
ZFE47   LDX     A1IOBUF                  *FE47: BE 9F 04       '...'
...
ZFECB   BSR     _XCMDCHK                 *FECB: 8D 13          '..'
        BCS     ZFEDF                    *FECD: 25 10          '%.'
        ASLA                             *FECF: 48             'H'
        ASLA                             *FED0: 48             'H'
        ASLA                             *FED1: 48             'H'
        ASLA                             *FED2: 48             'H'
        TFR     A,B                      *FED3: 1F 89          '..'
        BSR     _XCMDCHK                 *FED5: 8D 09          '..'
        BCS     ZFEBE                    *FED7: 25 E5          '%.'
        PSHS    B                        *FED9: 34 04          '4.'
        ADDA    ,S                       *FEDB: AB E4          '..'
        LEAS    $01,S                    *FEDD: 32 61          '2a'
ZFEDF   RTS                              *FEDF: 39             '9'
_XCMDCHK LDA     ,X+                      *FEE0: A6 80          '..'
_ACMDCHK SUBA    #$30                     *FEE2: 80 30          '.0'    CONVERT TO ASCII
        BMI     _SETC                    *FEE4: 2B 11          '+.'    IF <0 SET CARRY, RETURN
        CMPA    #$09                     *FEE6: 81 09          '..'    ASCII NUMBER 9
        BLE     _CLRC                    *FEE8: 2F 0A          '/.'    IF <=, CLEAR CARRY, RETURN
        CMPA    #$11                     *FEEA: 81 11          '..'    ';'
        BMI     _SETC                    *FEEC: 2B 09          '+.'    IF [:-9], SET CARRY, RETURN
        CMPA    #$16                     *FEEE: 81 16          '..'    '@'
        BGT     _SETC                    *FEF0: 2E 05          '..'    IF >, SET CARRY, RETURN
        SUBA    #$07                     *FEF2: 80 07          '..'    ';<=>?@' ARE LEFT
...
ZFF73   PSHS    D                        *FF73: 34 06          '4.'
        ...
        STU     MFFFF                    *FFE0: FF FF FF       '...'
MFFE3   STU     MFFFF                    *FFE3: FF FF FF       '...'
        STU     MFFFF                    *FFE6: FF FF FF       '...'
        STU     MFFFF                    *FFE9: FF FF FF       '...'
        STU     MFFFF                    *FFEC: FF FF FF       '...'
        STU     >Z0000                   *FFEF: FF 00 00       '...'
