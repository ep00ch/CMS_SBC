...
_RDCL2  LDB     #12                      *E79A: C6 0C          '..'    START AT RTC DECADE ADDR
        LDX     ,S                       *E79C: AE E4          '..'
_RDCL3  BSR     _RTC_READ                *E79E: 8D 0F          '..'    GET THE DIGIT
...
_RTC_READ PSHS    D                        *E7AF: 34 06          '4.'    SAVE A&B REGISTERS
        ...
        PULS    PC,D                     *E7D9: 35 86          '5.'    RESTORE A&D, RTS
_RTC_SSR PSHS    D                        *E7DB: 34 06          '4.'
        ...
        STU     MFFFF                    *E7FD: FF FF FF       '...'
ME800   FDB     MAA55                    *E800: AA 55          '.U'
EXT_CMDTBL FDB     $EFDB                    *E802: EF DB          '..'
        LBRA    ZE863                    *E804: 16 00 5C       '..\'
ZE807   LBRA    ZE87A                    *E807: 16 00 70       '..p'
ME80A   FCB     $9D,$00                  *E80A: 9D 00          '..'
ME80C   FCB     $FF,$CC                  *E80C: FF CC          '..'
ME80E   FCB     $FF,$CD                  *E80E: FF CD          '..'
ME810   FCB     $FF,$CE                  *E810: FF CE          '..'
ME812   FCB     $FF,$CF                  *E812: FF CF          '..'
ME814   FCB     $FF,$C8                  *E814: FF C8          '..'
ME816   FCB     $FF,$C9                  *E816: FF C9          '..'
ME818   FCB     $FF,$CA                  *E818: FF CA          '..'
ME81A   FCB     $FF,$CB                  *E81A: FF CB          '..'
ME81C   FCB     $FF,$D4                  *E81C: FF D4          '..'
ME81E   FCB     $FF,$D5                  *E81E: FF D5          '..'
ME820   FCB     $08                      *E820: 08             '.'
ME821   FCB     $10                      *E821: 10             '.'
ZE822   BSR     ZE827                    *E822: 8D 03          '..'
        BCS     ZE822                    *E824: 25 FC          '%.'
        RTS                              *E826: 39             '9'
ZE827   PSHS    A                        *E827: 34 02          '4.'
        LDA     [>ME81E,PCR]             *E829: A6 9D FF F1    '....'
        BITA    >ME820,PCR               *E82D: A5 8D FF EF    '....'
        BEQ     ZE83E                    *E831: 27 0B          ''.'
        PULS    A                        *E833: 35 02          '5.'
        LDA     [>ME81C,PCR]             *E835: A6 9D FF E3    '....'
        ANDA    #$7F                     *E839: 84 7F          '..'
        ANDCC   #$FE                     *E83B: 1C FE          '..'
        RTS                              *E83D: 39             '9'
ZE83E   ORCC    #$01                     *E83E: 1A 01          '..'
        PULS    PC,A                     *E840: 35 82          '5.'
ZE842   PSHS    A                        *E842: 34 02          '4.'    Appears to be the main command character processor
...
ZE852   LDA     [>ME81E,PCR]             *E852: A6 9D FF C8    '....'
        BITA    >ME821,PCR               *E856: A5 8D FF C7    '....'
        BEQ     ZE852                    *E85A: 27 F6          ''.'
        PULS    A                        *E85C: 35 02          '5.'
        STA     [>ME81C,PCR]             *E85E: A7 9D FF BA    '....'
        RTS                              *E862: 39             '9'
ZE863   CLRB                             *E863: 5F             '_'
        LDA     >ME80A,PCR               *E864: A6 8D FF A2    '....'
        TFR     A,DP                     *E868: 1F 8B          '..'
        TFR     D,X                      *E86A: 1F 01          '..'
        LDB     #$FF                     *E86C: C6 FF          '..'    SET LOOP COUNTER 255
ZE86E   CLR     ,X+                      *E86E: 6F 80          'o.'
        DECB                             *E870: 5A             'Z'     DECREMENT COUNTER
        BNE     ZE86E                    *E871: 26 FB          '&.'    KEEP LOOPING IF >0
        LBSR    ZEE5A                    *E873: 17 05 E4       '...'
        LDA     #$FF                     *E876: 86 FF          '..'
        STA     M0096                    *E878: 97 96          '..'
ZE87A   LDD     >ME80A,PCR               *E87A: EC 8D FF 8C    '....'
        TFR     A,DP                     *E87E: 1F 8B          '..'
...
ZEADE   PULS    PC,A                     *EADE: 35 82          '5.'
        ...
        LDB     #$00                     *EAF8: C6 00          '..'
ZEAFA   PSHS    B                        *EAFA: 34 04          '4.'
        LBSR    ZEE5A                    *EAFC: 17 03 5B       '..['
        PULS    B                        *EAFF: 35 04          '5.'
        ...
        LDA     #$FF                     *EB0A: 86 FF          '..'
        STA     M0096                    *EB0C: 97 96          '..'
ZEB0E   RTS                              *EB0E: 39             '9'
        JMP     [svec_RST]               *EB0F: 6E 9F FF FE    'n...'
ZEB13   LBSR    DIGIT                    *EB13: 17 01 51       '..Q'
        BCS     ZEB1B                    *EB16: 25 03          '%.'
        LBSR    ZE842                    *EB18: 17 FD 27       '..''
ZEB1B   RTS                              *EB1B: 39             '9'
ZEB1C   PSHS    X,D                      *EB1C: 34 16          '4.'
        LEAX    MESSGES,PCR              *EB1E: 30 8D 01 D3    '0...'
ZEB22   CMPA    #$08                     *EB22: 81 08          '..'
        BLS     ZEB28                    *EB24: 23 02          '#.'
        LDA     #$06                     *EB26: 86 06          '..'
ZEB28   ASLA                             *EB28: 48             'H'
        LDD     A,X                      *EB29: EC 86          '..'
        LEAX    D,X                      *EB2B: 30 8B          '0.'
        LBSR    ZEBBE                    *EB2D: 17 00 8E       '...'
        PULS    PC,X,D                   *EB30: 35 96          '5.'
ZEB32   PSHS    X,D                      *EB32: 34 16          '4.'
        BRA     ZEB22                    *EB34: 20 EC          ' .'
ZEB36   LDX     M0082                    *EB36: 9E 82          '..'
        LEAY    MEDB4,PCR                *EB38: 31 8D 02 78    '1..x'
ZEB3C   LDA     ,X+                      *EB3C: A6 80          '..'
        LBSR    DIGIT                    *EB3E: 17 01 26       '..&'
...
ZEB81   PSHS    A                        *EB81: 34 02          '4.'
        ...
        LSRA                             *EB85: 44             'D'
        LSRA                             *EB86: 44             'D'
        BSR     ZEB8F                    *EB87: 8D 06          '..'
        LDA     ,S                       *EB89: A6 E4          '..'
        BSR     ZEB8F                    *EB8B: 8D 02          '..'
        PULS    PC,A                     *EB8D: 35 82          '5.'
...
ZEBC9   PULS    PC,X,A                   *EBC9: 35 92          '5.'
...
MESSGES FCB     $00,$12,$00              *ECF5: 00 12 00       '...'
        ...
        FCB     $00                      *EDB3: 00             '.'
MEDB4   FCC     "PROG"                   *EDB4: 50 52 4F 47    'PROG'
        FCB     $00,$FC                  *EDB8: 00 FC          '..'
        FCC     "2STAT"                  *EDBA: 32 53 54 41 54 '2STAT'
        ...
        FCC     "=VIEW"                  *EDCF: 3D 56 49 45 57 '=VIEW'
...
MEE29   FCB     $15                      *EE29: 15             '.'
        ...
        LBRA    Z3548                    *EE3E: 16 47 07       '.G.'
        ADDB    #$10                     *EE41: CB 10          '..'
        NEG     M0014                    *EE43: 00 14          '..'
        LBRA    Z354F                    *EE45: 16 47 07       '.G.'
        ADDD    -$10,X                   *EE48: E3 10          '..'
        NEG     M0014                    *EE4A: 00 14          '..'
        ROR     M6620                    *EE4C: 76 66 20       'vf '
        ROLA                             *EE4F: 49             'I'
        BRA     ZEE52                    *EE50: 20 00          ' .'
ZEE52   FCB     $18                      *EE52: 18             '.'
        ROR     M6620                    *EE53: 76 66 20       'vf '
        ROLA                             *EE56: 49             'I'
        NEGA                             *EE57: 40             '@'
        NEG     M0018                    *EE58: 00 18          '..'
ZEE5A   LEAY    ME81C,PCR                *EE5A: 31 8D F9 BE    '1...'
        LDA     #$08                     *EE5E: 86 08          '..'
ZEE60   CLR     [,--Y]                   *EE60: 6F B3          'o.'
        DECA                             *EE62: 4A             'J'
        BNE     ZEE60                    *EE63: 26 FB          '&.'
        LDA     #$0F                     *EE65: 86 0F          '..'
        STA     [>ME818,PCR]             *EE67: A7 9D F9 AD    '....'
        LDA     #$34                     *EE6B: 86 34          '.4'
        STA     [>ME81A,PCR]             *EE6D: A7 9D F9 A9    '....'
        LDA     [>ME818,PCR]             *EE71: A6 9D F9 A3    '....'
        CLR     [>ME81A,PCR]             *EE75: 6F 9D F9 A1    'o...'
        ANDA    #$C0                     *EE79: 84 C0          '..'
        BEQ     ZEE8F                    *EE7B: 27 12          ''.'
        CMPA    #$80                     *EE7D: 81 80          '..'
        BEQ     ZEE94                    *EE7F: 27 13          ''.'
        CMPA    #$40                     *EE81: 81 40          '.@'
        BEQ     ZEE9F                    *EE83: 27 1A          ''.'
        LDA     #$01                     *EE85: 86 01          '..'
        LBSR    ZEB1C                    *EE87: 17 FC 92       '...'
        LDB     #$01                     *EE8A: C6 01          '..'
        ORCC    #$01                     *EE8C: 1A 01          '..'
        RTS                              *EE8E: 39             '9'
ZEE8F   LDD     #M1700                   *EE8F: CC 17 00       '...'
        BRA     ZEEA2                    *EE92: 20 0E          ' .'
ZEE94   LDA     #$3F                     *EE94: 86 3F          '.?'
        STA     [>ME818,PCR]             *EE96: A7 9D F9 7E    '...~'
        LDD     #M1805                   *EE9A: CC 18 05       '...'
        BRA     ZEEA2                    *EE9D: 20 03          ' .'
ZEE9F   LDD     #M1401                   *EE9F: CC 14 01       '...'
ZEEA2   STA     M009D                    *EEA2: 97 9D          '..'
        LDA     #$FF                     *EEA4: 86 FF          '..'
        STA     [>ME814,PCR]             *EEA6: A7 9D F9 6A    '...j'
        STA     [>ME80C,PCR]             *EEAA: A7 9D F9 5E    '...^'
        LDA     #$34                     *EEAE: 86 34          '.4'
        STA     [>ME80E,PCR]             *EEB0: A7 9D F9 5A    '...Z'
        STA     [>ME816,PCR]             *EEB4: A7 9D F9 5E    '...^'
        STA     [>ME81A,PCR]             *EEB8: A7 9D F9 5E    '...^'
...
ZEECC   CMPY    M0099                    *EECC: 10 9C 99       '...'
        ...
        TFR     Y,D                      *EED1: 1F 20          '. '
        STA     [>ME818,PCR]             *EED3: A7 9D F9 41    '...A'
        STB     [>ME814,PCR]             *EED7: E7 9D F9 39    '...9'
        LDA     [>ME810,PCR]             *EEDB: A6 9D F9 31    '...1'
        CLRB                             *EEDF: 5F             '_'
        RTS                              *EEE0: 39             '9'
...
ZEEF6   CMPY    M0099                    *EEF6: 10 9C 99       '...'
        ...
        TFR     Y,D                      *EEFB: 1F 20          '. '
        STA     [>ME818,PCR]             *EEFD: A7 9D F9 17    '....'
        STB     [>ME814,PCR]             *EF01: E7 9D F9 0F    '....'
        PULS    A                        *EF05: 35 02          '5.'
        CMPA    #$FF                     *EF07: 81 FF          '..'
        BEQ     ZEF19                    *EF09: 27 0E          ''.'
        TST     [>ME810,PCR]             *EF0B: 6D 9D F9 01    'm...'
        STA     [>ME810,PCR]             *EF0F: A7 9D F8 FD    '....'
ZEF13   TST     [>ME812,PCR]             *EF13: 6D 9D F8 FB    'm...'
...
ZEF1B   PSHS    X,D                      *EF1B: 34 16          '4.'
        ...
        LDA     $01,X                    *EF23: A6 01          '..'
        STA     [>ME80C,PCR]             *EF25: A7 9D F8 E3    '....'
        LDA     #$3A                     *EF29: 86 3A          '.:'
        STA     [>ME812,PCR]             *EF2B: A7 9D F8 E3    '....'
        LDB     #$FF                     *EF2F: C6 FF          '..'
        STB     [>ME810,PCR]             *EF31: E7 9D F8 DB    '....'
        ORA     #$04                     *EF35: 8A 04          '..'
        STA     [>ME812,PCR]             *EF37: A7 9D F8 D7    '....'
        LDA     #$64                     *EF3B: 86 64          '.d'
        LBSR    ZEFCB                    *EF3D: 17 00 8B       '...'
        LDA     ,X                       *EF40: A6 84          '..'
        STA     [>ME80C,PCR]             *EF42: A7 9D F8 C6    '....'
        CLRB                             *EF46: 5F             '_'
...
ZEF49   PSHS    X,D                      *EF49: 34 16          '4.'
        ...
        LDA     #$3E                     *EF51: 86 3E          '.>'
        LDB     M0096                    *EF53: D6 96          '..'
        CMPB    #$02                     *EF55: C1 02          '..'
        BNE     ZEF5B                    *EF57: 26 02          '&.'
        LDA     #$2E                     *EF59: 86 2E          '..'
ZEF5B   ANDA    #$FB                     *EF5B: 84 FB          '..'
        STA     [>ME812,PCR]             *EF5D: A7 9D F8 B1    '....'
        CLR     [>ME810,PCR]             *EF61: 6F 9D F8 AB    'o...'
        ORA     #$04                     *EF65: 8A 04          '..'
        STA     [>ME812,PCR]             *EF67: A7 9D F8 A7    '....'
        LDA     $02,X                    *EF6B: A6 02          '..'
        STA     [>ME80C,PCR]             *EF6D: A7 9D F8 9B    '....'
        LDA     #$4B                     *EF71: 86 4B          '.K'
        BSR     ZEFCB                    *EF73: 8D 56          '.V'
        LDA     [>ME810,PCR]             *EF75: A6 9D F8 97    '....'
        PULS    PC,X,D                   *EF79: 35 96          '5.'
ZEF7B   PSHS    X,A                      *EF7B: 34 12          '4.'
        LDA     #$02                     *EF7D: 86 02          '..'
        STA     M0093                    *EF7F: 97 93          '..'
        LDA     #$2B                     *EF81: 86 2B          '.+'
        STA     [>ME812,PCR]             *EF83: A7 9D F8 8B    '....'
        LDB     #$FF                     *EF87: C6 FF          '..'
        STB     [>ME810,PCR]             *EF89: E7 9D F8 83    '....'
        ORA     #$04                     *EF8D: 8A 04          '..'
        STA     [>ME812,PCR]             *EF8F: A7 9D F8 7F    '....'
        LDX     M0097                    *EF93: 9E 97          '..'
        LDA     $03,X                    *EF95: A6 03          '..'
        STA     [>ME80C,PCR]             *EF97: A7 9D F8 71    '...q'
        LDA     #$32                     *EF9B: 86 32          '.2'
        BSR     ZEFCB                    *EF9D: 8D 2C          '.,'
        PULS    PC,X,A                   *EF9F: 35 92          '5.'    restore X&A, RTS
ZEFA1   PSHS    X,D                      *EFA1: 34 16          '4.'    store X,D
        STB     M0096                    *EFA3: D7 96          '..'
        LDA     #$07                     *EFA5: 86 07          '..'
        MUL                              *EFA7: 3D             '='
        LEAX    MEE29,PCR                *EFA8: 30 8D FE 7D    '0..}'
        LEAX    D,X                      *EFAC: 30 8B          '0.'
        LDA     $06,X                    *EFAE: A6 06          '..'
        CMPA    M009D                    *EFB0: 91 9D          '..'
...
ZEFD0   LEAX    -$01,X                   *EFD0: 30 1F          '0.'
        ...
        NEG     M0000                    *EFD9: 00 00          '..'
        NEGB                             *EFDB: 50             'P'
        NEG     M00E8                    *EFDC: 00 E8          '..'
        COM     -$0D,U                   *EFDE: 63 53          'cS'
        NEG     M00E7                    *EFE0: 00 E7          '..'
        NEG     M0054                    *EFE2: 00 54          '.T'
        NEG     M00E7                    *EFE4: 00 E7          '..'
        TSTB                             *EFE6: 5D             ']'
        NEG     M0000                    *EFE7: 00 00          '..'
        STU     MFFFF                    *EFE9: FF FF FF       '...'
        STU     MFFFF                    *EFEC: FF FF FF       '...'
        STU     MFFFF                    *EFEF: FF FF FF       '...'
        STU     MFFFF                    *EFF2: FF FF FF       '...'
        STU     MFFFF                    *EFF5: FF FF FF       '...'
        STU     MFFFF                    *EFF8: FF FF FF       '...'
        STU     MFFFF                    *EFFB: FF FF FF       '...'
        STU     MFFAA                    *EFFE: FF FF AA       '...'
        FCB     $55                      *F001: 55             'U'
        SUBB    M0600                    *F002: F0 06 00       '...'
        NEG     M0044                    *F005: 00 44          '.D'
        ROLA                             *F007: 49             'I'
        NEG     M00F0                    *F008: 00 F0          '..'
        ANDCC   #$44                     *F00A: 1C 44          '.D'
        FCB     $42                      *F00C: 42             'B'
        NEG     M00F0                    *F00D: 00 F0          '..'
        RTS                              *F00F: 39             '9'
        FCC     "XD"                     *F010: 58 44          'XD'
        FCB     $00,$F0                  *F012: 00 F0          '..'
        FCC     "dTD"                    *F014: 64 54 44       'dTD'
        FCB     $00,$F0                  *F017: 00 F0          '..'
        FCC     "`"                      *F019: 60             '`'
        FCB     $00,$00,$BD,$FE          *F01A: 00 00 BD FE    '....'
        FCC     "*'"                     *F01E: 2A 27          '*''
        FCB     $0C,$BD,$FE,$BF          *F020: 0C BD FE BF    '....'
        FCC     "$"                      *F024: 24             '$'
        FCB     $05                      *F025: 05             '.'
ZF026   LDA     #$32                     *F026: 86 32          '.2'
        JMP     _NCMDERR                 *F028: 7E FD B2       '~..'
        STD     M0023                    *F02B: DD 23          '.#'
        LDY     #M9F23                   *F02D: 10 8E 9F 23    '...#'
        CLRA                             *F031: 4F             'O'
        CLR     M0022                    *F032: 0F 22          '."'
        LBSR    ZF0AE                    *F034: 17 00 77       '..w'
        BRA     ZF05C                    *F037: 20 23          ' #'
        JSR     CHKEOL                   *F039: BD FE 2A       '..*'
        BNE     ZF042                    *F03C: 26 04          '&.'
        LDD     M0023                    *F03E: DC 23          '.#'
        BRA     ZF047                    *F040: 20 05          ' .'
ZF042   JSR     ZFEBF                    *F042: BD FE BF       '...'
        BCS     ZF026                    *F045: 25 DF          '%.'
ZF047   PSHS    D                        *F047: 34 06          '4.'
        LDA     #$16                     *F049: 86 16          '..'
        STA     M0022                    *F04B: 97 22          '."'
ZF04D   LEAY    ,S                       *F04D: 31 E4          '1.'
        CLRA                             *F04F: 4F             'O'
...
ZF1B2   LDX     #M9F87                   *F1B2: 8E 9F 87       '...'
        ...
        LDB     ,U                       *F1BD: E6 C4          '..'
        LDU     #MF475                   *F1BF: CE F4 75       '..u'
ZF1C2   ASLB                             *F1C2: 58             'X'
        LDA     ,U+                      *F1C3: A6 C0          '..'
        BCC     ZF1C9                    *F1C5: 24 02          '$.'
        STA     ,X+                      *F1C7: A7 80          '..'
ZF1C9   TSTB                             *F1C9: 5D             ']'
        BNE     ZF1C2                    *F1CA: 26 F6          '&.'
...
MF475   FCC     "EFHINZVC"               *F475: 45 46 48 49 4E 5A 56 43 'EFHINZVC'
...
ZF5BD   FCC     "ORCC*** ANDCSEX EXG T"  *F5BD: 4F 52 43 43 2A 2A 2A 20 41 4E 44 43 53 45 58 20 45 58 47 20 54 'ORCC*** ANDCSEX EXG T'
        ...
        FCC     " ROL DEC"               *F6F8: 20 52 4F 4C 20 44 45 43 ' ROL DEC'
* 6819 INTERACTIVE DEBUG PROGRAM
        FCC     " *** INC TST JMP CLR "  *F700: 20 2A 2A 2A 20 49 4E 43 20 54 53 54 20 4A 4D 50 20 43 4C 52 20 ' *** INC TST JMP CLR '
        FCC     "SUBACMPASBCASUBDANDAB"  *F715: 53 55 42 41 43 4D 50 41 53 42 43 41 53 55 42 44 41 4E 44 41 42 'SUBACMPASBCASUBDANDAB'
        FCC     "ITALDA STA EORAADCAOR"  *F72A: 49 54 41 4C 44 41 20 53 54 41 20 45 4F 52 41 41 44 43 41 4F 52 'ITALDA STA EORAADCAOR'
        FCC     "A ADDACMPXJSR LDX STX"  *F73F: 41 20 41 44 44 41 43 4D 50 58 4A 53 52 20 4C 44 58 20 53 54 58 'A ADDACMPXJSR LDX STX'
        FCC     " SUBBCMPBSBCBADDDANDB"  *F754: 20 53 55 42 42 43 4D 50 42 53 42 43 42 41 44 44 44 41 4E 44 42 ' SUBBCMPBSBCBADDDANDB'
        FCC     "BITBLDB STB EORBADCBO"  *F769: 42 49 54 42 4C 44 42 20 53 54 42 20 45 4F 52 42 41 44 43 42 4F 'BITBLDB STB EORBADCBO'
        FCC     "RB ADDBLDD STD LDU ST"  *F77E: 52 42 20 41 44 44 42 4C 44 44 20 53 54 44 20 4C 44 55 20 53 54 'RB ADDBLDD STD LDU ST'
        FCC     "U "                     *F793: 55 20          'U '
...
A1INIT2 CLR     ,X+                      *F831: 6F 80          'o.'    CLEAR BKPT TABLE
        CMPX    IOBUF                    *F833: 9C 04          '..'
        BCS     A1INIT2                  *F835: 25 FA          '%.'    LOOP TIL CLEAR
...
COMAND  LDY     #PROMPT                  *F86E: 10 8E FD 2E    '....'  GET PROMPT STRING
        ...
        LEAY    REGLIST,PCR              *F882: 31 8D 04 C4    '1...'
        BSR     _CMDSRC                  *F886: 8D 2D          '.-'
        TSTA                             *F888: 4D             'M'     COMPARE TO TEXT
        BNE     ZF89E                    *F889: 26 13          '&.'
        LDY     ME800                    *F88B: 10 BE E8 00    '....'
        CMPY    #MAA55                   *F88F: 10 8C AA 55    '...U'  CHECK FOR EXTENDED CMD TABLE(?)
        BNE     ILLCMD                   *F893: 26 0D          '&.'
        LDY     EXT_CMDTBL               *F895: 10 BE E8 02    '....'  START OF EXTENDED CMD TABLE
        BSR     _CMDSRC                  *F899: 8D 1A          '..'
        TSTA                             *F89B: 4D             'M'
        BEQ     ILLCMD                   *F89C: 27 04          ''.'    EXIT IF NOT EXTENDED TABLE
...
ZF938   LBSR    ZFECB                    *F938: 17 05 90       '...'
...
ZF9D5   TST     ,X                       *F9D5: 6D 84          'm.'
        BEQ     ZFA44                    *F9D7: 27 6B          ''k'
...
REGSTR  FCC     " SP="                   *F9F3: 20 53 50 3D    ' SP='
        ...
        FCB     $81,$00,$17,$00          *FA16: 81 00 17 00    '....'
        FCC     "\"                      *FA1A: 5C             '\'
ZFA1B   FCB     $10                      *FA1B: 10             '.'
        FCC     "%"                      *FA1C: 25             '%'
        FCB     $FF                      *FA1D: FF             '.'
        FCC     "(4F"                    *FA1E: 28 34 46       '(4F'
ZFA21   LBSR    WRTLIN                   *FA21: 17 04 14       '...'
        LDB     #$10                     *FA24: C6 10          '..'
        PSHS    B                        *FA26: 34 04          '4.'
        TFR     U,D                      *FA28: 1F 30          '.0'
        LBSR    ZFE9D                    *FA2A: 17 04 70       '..p'
ZFA2D   LDA     ,U+                      *FA2D: A6 C0          '..'
        LBSR    ZFEA1                    *FA2F: 17 04 6F       '..o'
        DEC     ,S                       *FA32: 6A E4          'j.'
...
ZFA42   LEAS    $04,S                    *FA42: 32 64          '2d'
ZFA44   LBSR    WRTLIN                   *FA44: 17 03 F1       '...'
        RTS                              *FA47: 39             '9'
        BSR     ZFA77                    *FA48: 8D 2D          '.-'
...
ZFAAC   LDA     ,Y+                      *FAAC: A6 A0          '..'
        ...
        RTS                              *FAB4: 39             '9'
        LBSR    CHKEOL                   *FAB5: 17 03 72       '..r'
        BEQ     ZFAC4                    *FAB8: 27 0A          ''.'
        LBSR    ZFEBF                    *FABA: 17 04 02       '...'
...
ZFAC9   LDU     ,Y                       *FAC9: EE A4          '..'
        ...
        LDA     #$3F                     *FAD1: 86 3F          '.?'
        STA     ,U                       *FAD3: A7 C4          '..'
ZFAD5   LEAY    $03,Y                    *FAD5: 31 23          '1#'
        DECB                             *FAD7: 5A             'Z'
        BNE     ZFAC9                    *FAD8: 26 EF          '&.'
        LDS     M0000                    *FADA: 10 DE 00       '...'
        RTI                              *FADD: 3B             ';'
        LBSR    CHKEOL                   *FADE: 17 03 49       '..I'
        BEQ     ZFA93                    *FAE1: 27 B0          ''.'
        LBSR    ZFEBF                    *FAE3: 17 03 D9       '...'
        BCS     ZFA9A                    *FAE6: 25 B2          '%.'
        TFR     D,X                      *FAE8: 1F 01          '..'
        JSR     ,X                       *FAEA: AD 84          '..'
        RTS                              *FAEC: 39             '9'
        LBSR    CHKEOL                   *FAED: 17 03 3A       '..:'
...
ZFB03   LEAY    $03,Y                    *FB03: 31 23          '1#'
        DEC     ,S                       *FB05: 6A E4          'j.'
        BNE     ZFAFC                    *FB07: 26 F3          '&.'
        LEAS    $01,S                    *FB09: 32 61          '2a'
        LBRA    WRTLIN                   *FB0B: 16 03 2A       '..*'
ZFB0E   LBSR    ZFEBF                    *FB0E: 17 03 AE       '...'
ZFB11   LBCS    ZF947                    *FB11: 10 25 FE 32    '.%.2'
        PSHS    D                        *FB15: 34 06          '4.'
...
ZFB29   PULS    D                        *FB29: 35 06          '5.'
        STD     ,Y                       *FB2B: ED A4          '..'
        RTS                              *FB2D: 39             '9'
        LBSR    CHKEOL                   *FB2E: 17 02 F9       '...'
        BEQ     ZFB45                    *FB31: 27 12          ''.'
        LBSR    ZFEBF                    *FB33: 17 03 89       '...'
...
ZFB59   CMPU    ,Y                       *FB59: 11 A3 A4       '...'
        BEQ     ZFB67                    *FB5C: 27 09          ''.'
        LEAY    $03,Y                    *FB5E: 31 23          '1#'
        DECB                             *FB60: 5A             'Z'
        BNE     ZFB59                    *FB61: 26 F6          '&.'
        LDB     #$0C                     *FB63: C6 0C          '..'
        ANDCC   #$FB                     *FB65: 1C FB          '..'
ZFB67   PULS    PC,U                     *FB67: 35 C0          '5.'
ZFB69   CLR     M0019                    *FB69: 0F 19          '..'
ZFB6B   LDS     M0000                    *FB6B: 10 DE 00       '...'
        CLR     TIMER                    *FB6E: 7F FF D8       '...'
        RTI                              *FB71: 3B             ';'
        LBSR    CHKEOL                   *FB72: 17 02 B5       '...'
        BEQ     ZFB80                    *FB75: 27 09          ''.'
        LBSR    ZFEBF                    *FB77: 17 03 45       '..E'
        LBCS    ZF947                    *FB7A: 10 25 FD C9    '.%..'
        STD     M001A                    *FB7E: DD 1A          '..'
ZFB80   LDD     M001A                    *FB80: DC 1A          '..'
        BNE     ZFB88                    *FB82: 26 04          '&.'
        LDA     #$37                     *FB84: 86 37          '.7'
        BRA     ZFB26                    *FB86: 20 9E          ' .'
ZFB88   COM     M0019                    *FB88: 03 19          '..'
        BRA     ZFB6B                    *FB8A: 20 DF          ' .'
        LDA     #$FF                     *FB8C: 86 FF          '..'
        STA     M002B                    *FB8E: 97 2B          '.+'
        BRA     ZFB94                    *FB90: 20 02          ' .'
ZFB92   CLR     M002B                    *FB92: 0F 2B          '.+'
...
ZFC1A   LBSR    WRTLIN                   *FC1A: 17 02 1B       '...'
        ...
        LDY     #MFD30                   *FC22: 10 8E FD 30    '...0'
        LBSR    CPYSTR                   *FC26: 17 02 5F       '.._'
        LDA     $02,S                    *FC29: A6 62          '.b'
        LBSR    ZFEA1                    *FC2B: 17 02 73       '..s'
        LDY     #MFD34                   *FC2E: 10 8E FD 34    '...4'
        LBSR    CPYSTR                   *FC32: 17 02 53       '..S'
        LDA     $06,S                    *FC35: A6 66          '.f'
        LBSR    ZFEA1                    *FC37: 17 02 67       '..g'
        LDY     #MFD39                   *FC3A: 10 8E FD 39    '...9'
...
ZFCF9   CLR     M0019                    *FCF9: 0F 19          '..'
        ...
        RTI                              *FD00: 3B             ';'
MFD01   SWI                              *FD01: 3F             '?'
hdlr_SWI3 JMP     [Z9F0D]                  *FD02: 6E 9F 9F 0D    'n...'
hdlr_SWI2 JMP     [Z9F0F]                  *FD06: 6E 9F 9F 0F    'n...'
hdlr_SWI JMP     [Z9F11]                  *FD0A: 6E 9F 9F 11    'n...'
hdlr_FIRQ JMP     [Z9F15]                  *FD0E: 6E 9F 9F 15    'n...'
hdlr_IRQ JMP     [Z9F13]                  *FD12: 6E 9F 9F 13    'n...'
hdlr_NMI JMP     [Z9F17]                  *FD16: 6E 9F 9F 17    'n...'
...
PROMPT  FCC     ":"                      *FD2E: 3A             ':'
        FCB     $00                      *FD2F: 00             '.'
MFD30   FCC     "OK "                    *FD30: 4F 4B 20       'OK '
        FCB     $00                      *FD33: 00             '.'
MFD34   FCC     "BAD "                   *FD34: 42 41 44 20    'BAD '
        FCB     $00                      *FD38: 00             '.'
MFD39   FCC     "VERF PROBLEMS"          *FD39: 56 45 52 46 20 50 52 4F 42 4C 45 4D 53 'VERF PROBLEMS'
        FCB     $07,$00,$F0,$00          *FD46: 07 00 F0 00    '....'
REGLIST FCC     "A"                      *FD4A: 41             'A'
        FCB     $00,$F8,$FE              *FD4B: 00 F8 FE       '...'
        FCC     "B"                      *FD4E: 42             'B'
        FCB     $00,$F9,$02              *FD4F: 00 F9 02       '...'
        FCC     "CC"                     *FD52: 43 43          'CC'
        FCB     $00,$F9,$06              *FD54: 00 F9 06       '...'
        FCC     "DP"                     *FD57: 44 50          'DP'
        FCB     $00,$F9,$09              *FD59: 00 F9 09       '...'
        FCC     "PC"                     *FD5C: 50 43          'PC'
        FCB     $00,$F9                  *FD5E: 00 F9          '..'
        FCC     "mR"                     *FD60: 6D 52          'mR'
        FCB     $00,$F9,$C6              *FD62: 00 F9 C6       '...'
        FCC     "SP"                     *FD65: 53 50          'SP'
        FCB     $00,$F9                  *FD67: 00 F9          '..'
        FCC     "[U"                     *FD69: 5B 55          '[U'
        FCB     $00,$F9                  *FD6B: 00 F9          '..'
        FCC     "aX"                     *FD6D: 61 58          'aX'
        FCB     $00,$F9                  *FD6F: 00 F9          '..'
        FCC     "eY"                     *FD71: 65 59          'eY'
        FCB     $00,$F9                  *FD73: 00 F9          '..'
        FCC     "iE"                     *FD75: 69 45          'iE'
        FCB     $00,$F9,$9F              *FD77: 00 F9 9F       '...'
        FCC     "V"                      *FD7A: 56             'V'
        FCB     $00,$FA,$18              *FD7B: 00 FA 18       '...'
        FCC     "C"                      *FD7E: 43             'C'
        FCB     $00,$FA                  *FD7F: 00 FA          '..'
        FCC     "HM"                     *FD81: 48 4D          'HM'
        FCB     $00,$FA,$90              *FD83: 00 FA 90       '...'
        FCC     "G"                      *FD86: 47             'G'
        FCB     $00,$FA,$B5              *FD87: 00 FA B5       '...'
        FCC     "J"                      *FD8A: 4A             'J'
        FCB     $00,$FA,$DE              *FD8B: 00 FA DE       '...'
        FCC     "BK"                     *FD8E: 42 4B          'BK'
        FCB     $00,$FA,$ED              *FD90: 00 FA ED       '...'
        FCC     "KB"                     *FD93: 4B 42          'KB'
        FCB     $00,$FB                  *FD95: 00 FB          '..'
        FCC     ".N"                     *FD97: 2E 4E          '.N'
        FCB     $00,$FB                  *FD99: 00 FB          '..'
        FCC     "iGT"                    *FD9B: 69 47 54       'iGT'
        FCB     $00,$FB                  *FD9E: 00 FB          '..'
        FCC     "rL"                     *FDA0: 72 4C          'rL'
        FCB     $00,$FB,$92              *FDA2: 00 FB 92       '...'
        FCC     "VL"                     *FDA5: 56 4C          'VL'
        NEG     M00FB                    *FDA7: 00 FB          '..'
        CMPX    #M0000                   *FDA9: 8C 00 00       '...'
        LBRA    ZF8CD                    *FDAC: 16 FB 1E       '...'
_NCOMAND LBRA    COMAND                   *FDAF: 16 FA BC       '...'
_NCMDERR LBRA    CMDERR                   *FDB2: 16 FA F3       '...'
_NSSBK  LBRA    SSBK                     *FDB5: 16 FF 19       '...'
ZFDB8   LBRA    ZFB69                    *FDB8: 16 FD AE       '...'
        LBRA    ZFB92                    *FDBB: 16 FD D4       '...'
...
ZFEA1   BSR     ZFEA8                    *FEA1: 8D 05          '..'
        ...
        RTS                              *FEA7: 39             '9'
ZFEA8   PSHS    A                        *FEA8: 34 02          '4.'
        BSR     ZFEB0                    *FEAA: 8D 04          '..'
        PULS    A                        *FEAC: 35 02          '5.'
        BRA     ZFEB4                    *FEAE: 20 04          ' .'
ZFEB0   LSRA                             *FEB0: 44             'D'
        LSRA                             *FEB1: 44             'D'
        LSRA                             *FEB2: 44             'D'
        LSRA                             *FEB3: 44             'D'
...
ZFEBE   RTS                              *FEBE: 39             '9'
ZFEBF   BSR     ZFECB                    *FEBF: 8D 0A          '..'
        BCS     ZFEBE                    *FEC1: 25 FB          '%.'
        PSHS    A                        *FEC3: 34 02          '4.'
        BSR     ZFECB                    *FEC5: 8D 04          '..'
        TFR     A,B                      *FEC7: 1F 89          '..'
        PULS    PC,A                     *FEC9: 35 82          '5.'
ZFECB   BSR     _CHEXBIN                 *FECB: 8D 13          '..'
...
ZFF73   PSHS    D                        *FF73: 34 06          '4.'
        ...
        STU     MFFFF                    *FF7F: FF FF FF       '...'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FF82: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FF88: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FF8E: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FF94: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FF9A: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FFA0: FF FF FF FF FF FF '......'
        FCB     $FF,$FF,$FF,$FF          *FFA6: FF FF FF FF    '....'
MFFAA   FCB     $FF,$FF,$FF,$FF,$FF,$FF  *FFAA: FF FF FF FF FF FF '......'
